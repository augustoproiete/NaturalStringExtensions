...
{
    /// <summary>
    /// Extension methods to <see cref="StringComparison"/> to make it easier to use <see cref="NaturalStringComparer"/>
    /// </summary>
    public static class StringComparisonExtensions
    {
        /// <summary>
        /// Create a <see cref="NaturalStringComparer"/> with the <paramref name="comparisonType"/> provided
