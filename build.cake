...
Task("restore")
    ...
    .Does(() =>
{
    DotNetRestore("./NaturalStringExtensions.sln", new DotNetRestoreSettings
    {
        LockedMode = true,
    });
});
...
{
    DotNetBuild("./NaturalStringExtensions.sln", new DotNetBuildSettings
    {
    ...
    .Does(() =>
{
    ...
    DotNetPack("./src/NaturalStringExtensions/NaturalStringExtensions.csproj", new DotNetPackSettings
    {
        Configuration = "Release",
        NoRestore = true,
        NoBuild = true,
